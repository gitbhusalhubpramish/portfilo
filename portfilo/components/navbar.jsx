export default function Navbar(){
	...
	>
     <div className="flex items-center justify-between">
        <h1 className="ttext-lg sm:text-xl md:text-2xl font-semibold">Pramish</h1>

        <div className="flex text-[#9b9b9b] w-1/2 justify-around ">
			<ul className="list-none text-sm sm:text-base md:text-lg hover:text-[#e4e4e4]">
				<li>
					<a href="/" className="hover:text-[#0b1120]/50 text-sm sm:text-base md:text-lg hover:text-[#e4e4e4]">Home</a>
				</li>
			</ul>
			<ul className="list-none text-sm sm:text-base md:text-lg hover:text-[#e4e4e4]">
				<li>
