...
export default function Navbar() {
  ...
  const navcls = "fixed top-4 left-1/2 -translate-x-1/2 w-11/12 max-w-4xl z-50 backdrop-blur-md bg-white/90 border border-white/20 rounded-xl py-4 px-6 text-[#0b1120]/50"
