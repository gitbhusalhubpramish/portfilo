    ...
    <div className="flex flex-col h-screen text-base"> 
		...
		<div className="mb-4 flex justify-end flex-1 flex-col">
			...
			<div className="flex gap-4 justify-end mr-4">
				...
				<a href="https://www.github.com/gitbhusalhubpramish/" className="w-12 h-12 flex items-center justify-center rounded-full bg-[#1c1f2b] hover:bg-[#0c0e13] transition-colors">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#ffffff" viewBox="0 0 24 24">
